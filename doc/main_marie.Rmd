...
Anaylizing the boxplot, we see that the hybrid method gets the best results. If you want a faster method by using only one of the features, then the title of the paper is the best choice. 
