...
```{r}
temp <- as.list(readLines(paste0("../data/nameset/", files[1],".txt")))
```
...
# Clean data files
  ...
  line.str <- substring(line.str, nchar(paper_id)+1, nchar(line.str))
  paper_id <- as.numeric(paper_id)
  
  # Get coauthor list
  line.str <- strsplit(line.str, "<>")[[1]]
  coauthor_list <- strsplit(line.str[1], ";")[[1]]
